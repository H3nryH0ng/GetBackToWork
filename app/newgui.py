...
class App(ctk.CTk):
    ...
    def create_dashboard_tab(self):
        ...
        active_app_frame = ctk.CTkFrame(self.dashboard_tab)
        ...
        ctk.CTkLabel(active_app_frame, text="Currently Active:", 
                    font=ctk.CTkFont(size=14)).grid(row=0, column=0, pady=5, padx=20, sticky="w")
        self.active_app_label = ctk.CTkLabel(active_app_frame, text="N/A", 
                                           font=ctk.CTkFont(size=14, slant="italic"))
        self.active_app_label.grid(row=0, column=1, pady=5, padx=20, sticky="w")
        ...
        # Recent Activity Log
        ctk.CTkLabel(self.dashboard_tab, text="Recent Activity:", 
                    font=ctk.CTkFont(size=14, weight="bold")).pack(pady=(10, 5), padx=20, anchor="w")
        self.activity_log_text = ctk.CTkTextbox(self.dashboard_tab, height=150, activate_scrollbars=True, wrap="word")
        self.activity_log_text.pack(pady=(0, 20), padx=20, fill="both", expand=True)
        self.activity_log_text.insert("end", "Welcome to GetB@ck2Work!\n")
        self.activity_log_text.configure(state="disabled")

        # Quick Action Button (Redeem Points)
        redeem_button = ctk.CTkButton(self.dashboard_tab, text="Redeem Points", 
                                     font=ctk.CTkFont(size=16, weight="bold"), 
                                     command=self.switch_tab_to_redeem_points)
